...
import { Base, WSManMessageCreator, genericDelete, genericRequestStateChange } from '../WSMan'
...
class KVMRedirectionSAP extends Base {
   ...
   * @returns string
   */
  RequestStateChange = (requestedState: Types.KVMRedirectionSAP.RequestedStateInputs): string => genericRequestStateChange(REQUEST_STATE_CHANGE(Classes.KVM_REDIRECTION_SAP), this.className, requestedState, this.wsmanMessageCreator)
}
...
class WiFiPort extends Base {
   ...
   * @returns string
   */
  RequestStateChange = (requestedState: Types.WiFiPort.RequestedState): string => genericRequestStateChange(REQUEST_STATE_CHANGE(Classes.WIFI_PORT), this.className, requestedState, this.wsmanMessageCreator)
}
