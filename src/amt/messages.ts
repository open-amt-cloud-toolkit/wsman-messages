...
import { CIM } from '../'
import { Base, BaseActions, WSManErrors, WSManMessageCreator, genericCreate, genericDelete, genericPut, genericRequestStateChange } from '../WSMan'
...
class AlarmClockService extends Base {
   ...
   * @returns string
   */
  Put = (alarmClockService: Models.AlarmClockService): string => genericPut(alarmClockService, this.wsmanMessageCreator, this.className, false)
}
...
class BootSettingData extends Base {
   ...
   * @returns string
   */
  Put = (bootSettingData: Models.BootSettingData): string => genericPut(bootSettingData, this.wsmanMessageCreator, this.className, false)
}
class EnvironmentDetectionSettingData extends Base {
   ...
   * @returns string
   */
  Put = (environmentDetectionSettingData: Models.EnvironmentDetectionSettingData): string => genericPut(environmentDetectionSettingData, this.wsmanMessageCreator, this.className, true)
}
class EthernetPortSettings extends Base {
   ...
   * @returns string
   */
  Put = (ethernetPortObject: Models.EthernetPortSettings): string => genericPut(ethernetPortObject, this.wsmanMessageCreator, this.className, true)
}
class GeneralSettings extends Base {
   ...
   * @returns string
   */
  Put = (generalSettings: Models.GeneralSettings): string => genericPut(generalSettings, this.wsmanMessageCreator, this.className, false)
}
...
class IEEE8021xProfile extends Base {
   ...
   * @returns string
   */
  Put = (ieee8021xProfile: Models.IEEE8021xProfile): string => genericPut(ieee8021xProfile, this.wsmanMessageCreator, this.className, false)
}
...
class ManagementPresenceRemoteSAP extends Base {
   ...
   * @returns string
   */
  Delete = (selector: Selector): string => genericDelete(selector, this.wsmanMessageCreator, this.className)
}
...
class MPSUsernamePassword extends Base {
  ...
  * @returns string
  */
  Put = (mpsUsernamePassword: Models.MPSUsernamePassword): string => genericPut(mpsUsernamePassword, this.wsmanMessageCreator, this.className, false)
}
class PublicKeyCertificate extends Base {
   ...
   * @returns string
   */
  Put = (publicKeyCertificate: Models.PublicKeyCertificate): string => genericPut(publicKeyCertificate, this.wsmanMessageCreator, this.className, false)
}
...
class RedirectionService extends Base {
   ...
   * @returns string
   */
  Put = (redirectionService: Models.RedirectionService): string => genericPut(redirectionService, this.wsmanMessageCreator, this.className, false)
  /**
   ...
   * @returns string
   */
  RequestStateChange = (requestedState: Types.RedirectionService.RequestedState): string => genericRequestStateChange(REQUEST_STATE_CHANGE(this.className), this.className, requestedState, this.wsmanMessageCreator)
}
class RemoteAccessPolicyAppliesToMPS extends Base {
  ...
  */
   ...
   * @returns string
   */
  Create = (remoteAccessPolicyAppliesToMPS: Models.RemoteAccessPolicyAppliesToMPS): string => genericCreate(remoteAccessPolicyAppliesToMPS, this.wsmanMessageCreator, this.className)
  /**
   * Changes properties of RemoteAccessPolicyAppliesToMPS.
   * @param remoteAccessPolicyAppliesToMPS RemoteAccessPolicyAppliesToMPS Object.
   * @returns string
   */
  Put = (remoteAccessPolicyAppliesToMPS: Models.RemoteAccessPolicyAppliesToMPS): string => genericPut(remoteAccessPolicyAppliesToMPS, this.wsmanMessageCreator, this.className, false)
}
class RemoteAccessPolicyRule extends Base {
   ...
   * @returns string
   */
  Put = (remoteAccessPolicyRule: Models.RemoteAccessPolicyRule): string => genericPut(remoteAccessPolicyRule, this.wsmanMessageCreator, this.className, false)
}
...
class SetupAndConfigurationService extends Base {
   ...
   * @returns string
   */
  Put = (setupAndConfigurationService: Models.SetupAndConfigurationService): string => genericPut(setupAndConfigurationService, this.wsmanMessageCreator, this.className, false)
}
...
class TLSSettingData extends Base {
   ...
   * @returns string
   */
  Put = (tlsSettingData: Models.TLSSettingData): string => genericPut(tlsSettingData, this.wsmanMessageCreator, this.className, true)
}
class UserInitiatedConnectionService extends Base {
   ...
   * @returns string
   */
  RequestStateChange = (requestedState: Types.UserInitiatedConnectionService.RequestedState): string => genericRequestStateChange(REQUEST_STATE_CHANGE(this.className), this.className, requestedState, this.wsmanMessageCreator)
}
class WiFiPortConfigurationService extends Base {
   ...
   * @returns string
   */
  Put = (wifiEndpointSettings: Models.WiFiPortConfigurationService, selector?: Selector): string => genericPut(wifiEndpointSettings, this.wsmanMessageCreator, this.className, false, selector)
}
