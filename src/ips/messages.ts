...
// import { CIM } from '../'
import { Base, WSManMessageCreator, genericDelete, genericPut } from '../WSMan'
...
class IEEE8021xSettings extends Base {
   ...
   * @returns string
   */
  Put = (ieee8021xSettings: Models.IEEE8021xSettings): string => genericPut(ieee8021xSettings, this.wsmanMessageCreator, this.className, false)
  /**
...
class OptInService extends Base {
  ...
  Put = (optInServiceResponse: Models.OptInServiceResponse): string => {
    ...
    return genericPut(optInServiceResponse[key], this.wsmanMessageCreator, this.className, false)
  }
