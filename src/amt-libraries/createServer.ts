...
function WsmanStackCreateService(CreateWsmanComm, host, port, user, pass, tls, tlsoption, extra) {
    ...
    if (CreateWsmanComm) {
        obj.comm = CreateWsmanComm(host, port, user, pass, tls, tlsoption ,extra);
    }
    //}
